...
if __name__ == '__main__':
    ...
    # e.g {'id': 'U_kgDOBii41Q'} for username 'tahaadams'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2002, 3, 4))
    ...
    if OWNER_ID == {'id': 'U_kgDOBii41Q'}: # only calculate for user tahaadams
